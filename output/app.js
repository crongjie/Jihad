...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RPage = __webpack_require__(72);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pages = {
		home: _home2.default, payment: _payment2.default
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RDesc = __webpack_require__(74);

	var _RDesc2 = _interopRequireDefault(_RDesc);

	var _RExample = __webpack_require__(75);

	var _RExample2 = _interopRequireDefault(_RExample);

	var _RMemo = __webpack_require__(76);

	var _RMemo2 = _interopRequireDefault(_RMemo);

	var _RNavBar = __webpack_require__(77);
...
/***/ function(module, exports) {
	...
	var mainmenu = {
	    title: 'JiBuy',
	    items: [{ text: 'Home', url: '/' }, { text: 'Orders', url: '/', items: [{ text: 'Add Orders', url: '/' }, { text: 'Check Status', url: '/' }, { text: 'History', url: '/' }, { type: 'separator' }, { text: 'JiBuy!', url: '/' }]
	    }, { text: 'Payment', url: '/payment' }, { text: 'About', url: '/' }, { text: 'Logout', url: '/' }]
	};
